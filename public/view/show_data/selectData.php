...
<!-- top card -->
<div class="conainer pkl__box">
<div class="pkl__letter">
<form>
<select class="form-control " name="open__box" id="open__box">
...
<div class="pkl__form box">
<div class="close-box">
<h5>PKL form</h5>
<h5 class="close_forms" aria-haspopup="true">x</h5>
</div>
<form id="pklform">
...
<div class="pkl__recommendation__form box">
<div class="close-box">
<h5 style="font-size: 16px;">Scholarship Recommendation Letter</h5>
<h5 class="close_forms">x</h5>
</div>
...
<script src="../../inc/js/open_form_js.js"></script>
<?php
